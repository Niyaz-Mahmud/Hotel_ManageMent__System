...
namespace HotelManageMentSystem
{
    public partial class addReceptionist : Form
    {
        ...
        public addReceptionist(Panel homepanel, int userID)
        {
            InitializeComponent();
        ...
        private void UpdateBT_Click(object sender, EventArgs e)
        {
            ...
            if (columnsToUpdate.Count > 0)
            {
                ...
                {
                    LoginEntity.UpdateFields(userId, "Receptionist", txtEmail.Text, txtPhone.Text);
                }

                int rowsAffected = ReceptionistEntity.UpdateReceptionistFields(userId, columnsToUpdate);
