...
namespace HotelManagementSystem
{
    ...
    {
        private readonly string connectionString = @"Data Source=N_P\SQLEXPRESS;Initial Catalog=Hotel_Management_System;Integrated Security=True";
        ...
        public static bool UpdateFields(int userId, string role, string newEmail, string newPhone)
        {
            try
            {
                string connectionString1 = @"Data Source=N_P\SQLEXPRESS;Initial Catalog=Hotel_Management_System;Integrated Security=True";
